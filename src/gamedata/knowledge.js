...
export const resources = {
    ...
    'wood': {name: 'Wood', style: 'bg-fuel',       is_nature: true,  vegetation: true, locked_till: 'embarked', difficulty: 3, max_cap: 6000, regen: 2, text: 'Exhaustible material and fuel from sawmill.'},
